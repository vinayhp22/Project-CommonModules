<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
	<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
		...
		<head>
			<title>Registration || Xworkz</title>
			<!-- Required meta tags -->
			<meta charset="utf-8">
		...
		<body>
			...
			<h3 style="color: orange;" align="center">${emailConfirmation}</h3>
			<h5 style="color: red;" align="center">
				<c:forEach items="${errors}" var="e"><br>${e.message}</c:forEach>
			</h5>
			<div class="container mt-5">
				<h1>Registration Form</h1>
				<form action="register" method="post">
					<div class="form-group">
						<label for="userId">UserId</label> <input type="text" class="form-control" id="userName"
							name="userId" value="${dto.userId}" onchange="userNameValidation()"> <a
							id="userNameValidationMessage" style="color: red"></a> <a id="userNameFromDB"
							style="color: red;"></a>
					</div>
					<div class="form-group">
						<label for="email">Email address</label> <input type="email" class="form-control" id="emailId"
							name="email" value="${dto.email}" onchange="emailValidation()"> <a
							id="emailValidationMessage" style="color: red"></a> </a> <a id="userEmailFromDB"
							style="color: red;"></a>
					</div>
					<div class="form-group">
						<label for="mobile">Mobile</label> <input type="number" class="form-control" id="mobileNo"
							name="mobile" value="${dto.mobile}" onchange="mobileValidation()"> <a
							id="mobileValidationMessage" style="color: red"></a> <a id="mobileFromDB"
							style="color: red"></a>
					</div>
					<div class="form-group">
						<label for="password">Password</label> <input type="password" class="form-control" id="password"
							name="password" value="${dto.password}" onblur="passwordValidation()"> <a
							id="passwordValidationMessage" style="color: red"></a> <input type="checkbox"
							onclick="showPassword()"> Show Password
					</div>
					<div class="form-group">
						<label for="confirm_password">Confirm Password</label> <input type="password"
							class="form-control" id="userConfirmPassword" name="confirmPassword"
							onblur="passwordComparision()"> <a id="passwordCompareMessage" style="color: red"></a>
					</div>
					<div class="form-group">
						<label for="agreement">I agree to the terms and conditions:
						</label> <input type="checkbox" name="agreement" id="agreement" onclick="onAgreement()"
							disabled="disabled">
					</div>
					<button type="submit" class="btn btn-primary" id="submit" disabled="disabled">Register</button>
				</form>
			</div>
