<%@page import="com.xworkz.vinayhp.service.CMSignInServiceImpl"%>
<%@page import="com.xworkz.vinayhp.dto.UserDTO"%>
<%@page import="org.springframework.beans.factory.annotation.Autowired"%>
<%@page import="com.xworkz.vinayhp.service.CMSignInService"%>
<%@page import="com.xworkz.vinayhp.service.CMSignUpService"%>
<%@page import="com.xworkz.vinayhp.resources.CMSignUpResources"%>
<%@page import="com.xworkz.vinayhp.resources.CMSignInResources"%>
...
<body>
	<header>
		<img alt="Xworkz Logo"
			src='<c:url value="/resources/images/xworkz_logo.png"/>' />
		<nav>
			<ul>
